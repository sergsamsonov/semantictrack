...
<jsp:include page="top.jsp">
    ...
    <jsp:param name="tickstform" value="active" />
    <jsp:param name="hormenu" value="admmenu" />
</jsp:include>
    <div class="panel-body">
      <c:url var="saveUrl" value="/admin/ticketstat/save" />
        <form:form modelAttribute="tickstatAttribute" method="POST" action="${saveUrl}">
            <c:if test="${tickstatAttribute.id != null}">
