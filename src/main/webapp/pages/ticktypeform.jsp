...
<jsp:include page="top.jsp">
    ...
    <jsp:param name="ticktypeform" value="active" />
    <jsp:param name="hormenu" value="admmenu" />
</jsp:include>
    <div class="panel-body">
      <c:url var="saveUrl" value="/admin/ticktypes/save" />
        <form:form modelAttribute="ticktypeAttribute" method="POST" action="${saveUrl}">
            <c:if test="${ticktypeAttribute.id != null}">
